                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                @forelse ($products as $product)
                                    ...
                                    <div class="modal fade" id="editProductModal{{ $product->slug }}" tabindex="-1" aria-labelledby="editProductModalLabel{{ $product->slug }}" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editProductModalLabel{{ $product->slug }}">Editar Producto</h5>
